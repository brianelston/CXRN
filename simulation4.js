...
include('scripts_sim4/Sim4_states.js');
include('scripts_utilities/UserResponseUtilities.js');
include('scripts_sim4/Sim4_UserResponse.js');
...
include('scripts_sim4/ExamUtilities_sim4.js');
include('scripts_utilities/TimerUtilities.js');
include('scripts_sim4/TimerUtilitiesSim4.js');
...
function SetProgressList() 
{
	...
	Machine=new StateMachine("Vasovagal", 1, 0, 0, 0);
	ResetStateMachine();
...
flashembed("mainmovieSIM", {src: "Scenario4_H264.swf", wmode: 'opaque', id: 'mainmovie'});
