...
include('scripts_sim2/Sim2_states.js');
include('scripts_utilities/UserResponseUtilities.js');
include('scripts_sim2/Sim2_UserResponse.js');
...
include('scripts_sim2/ExamUtilities_sim2.js');
include('scripts_utilities/TimerUtilities.js');
include('scripts_sim2/TimerUtilitiesSim2.js');
...
function StartSimulationSim2()
{
	//show a progress display - radio buton style
	//if already running or finished ask for confirmation

	//set the state variables
	Machine=new StateMachine("BronchospasmAndLaryngealEdema", 1, 0, 0, 0);	//state is Wait_For_Input
	ResetStateMachine();
	ResetStatVars();
...
function SetProgressList() 
{
	...
	Machine=new StateMachine("BronchospasmAndLaryngealEdema", 1, 0, 0, 0);
	ResetStateMachine();
...
flashembed("mainmovieSIM", {src: "Scenario2_H264.swf", wmode: 'opaque', id: 'mainmovie'});
